...
The Tandem methodology — the pair model, the spec → slice hierarchy, the quality gates, and the decision-point/lever protocol — is single-sourced from the canonical plugin file rather than duplicated here. Read it via the import below.
