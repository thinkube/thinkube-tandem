...
- **The bar: at most 2 actions before your first question to the user** — fetching `specs/SP-{n}/spec.md` (step 2) and writing the skeleton (step 3). No other reads before that question.
