  ...
  return [
    ...
    vscode.commands.registerCommand("thinkube-tandem.openDocs", async () => {
      ...
      const pages: { label: string; file: string }[] = [
        { label: "Thinkube Tandem", file: "index.adoc" },
        { label: "Using the space", file: "getting-started.adoc" },
        { label: "Every word on Tandem's pages", file: "reading-the-surface.adoc" },
        { label: "The defect ledger", file: "defect-ledger.adoc" },
        { label: "Configuration and settings", file: "configuration.adoc" },
        { label: "When something goes wrong", file: "troubleshooting.adoc" },
        { label: "Underneath: what happens to a sentence", file: "the-space.adoc" },
        { label: "Underneath: the two gates", file: "gates.adoc" },
        { label: "Underneath: how the machine builds", file: "the-run.adoc" },
        { label: "Underneath: the whole path, end to end", file: "end-to-end.adoc" },
        { label: "Underneath: projects and identity", file: "identity.adoc" },
        { label: "Underneath: the store", file: "store.adoc" },
        { label: "Underneath: the defect ledger, reference", file: "defects.adoc" },
      ];
