/**
 * The run harness shared by the tests that drive dispatchTep end to end:
 * a real temporary git repository, a one-change space, a green probe, and
 * a writer into a tree.
 */
...
export function spaceWithOneChange(): { space: Space; ids: string[] } {
  let s = emptySpace();
...
export function writeInto(root: string, rel: string, content: string): void {
