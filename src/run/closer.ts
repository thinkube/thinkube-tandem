...
export function closerBrief(a: {
  ...
  const lines = [
    ...
    "in its own words. Tidying, rewording, correcting what nobody complained about, or finishing",
    "a file because you are already in it is work the person did not ask for: it is reported to",
    "them as exactly that, and it makes a small repair into a change they must review. If you",
    "believe something else is wrong, say so in your report — do not fix it.",
    "",
