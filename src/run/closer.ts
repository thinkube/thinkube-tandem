...
export function closerBrief(a: {
  ...
  const lines = [
    ...
    "",
    "THE SECOND LAW: repair what is failing, and nothing else. What is failing is named below,",
    "in its own words. For anything else you notice, ask one question: does it stop this work",
    "being delivered? If it does, it is part of what is failing and you fix it. If it does not,",
    "leave it exactly as you found it and write a line beginning `FINDING: ` saying what you saw",
    "and where. The delivery carries it and the person decides whether it becomes work.",
    "",
