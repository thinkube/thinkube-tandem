...
import {
  ...
  PluginTemplate as Template,
} from "../../services/PluginTemplates";
...
export class PluginCreationWizard {
  ...
  private async stepMarketplace(): Promise<
    "thinkube" | "thinkube-platform" | undefined
  > {
    ...
    return selected.label.includes("Platform")
      ? "thinkube-platform"
      : "thinkube";
  }

  private async stepComponents(): Promise<
    WizardState["components"] | undefined
  > {
    const items: vscode.QuickPickItem[] = [
      {
