...
export interface Delivery {
   ...
   *  this one commit. */
  mergedHead?: string;
  /** The project already held this work: the merge moved nothing and the
   *  push had nothing to send. There is no build to wait for — what is
   *  live is what was already there. */
