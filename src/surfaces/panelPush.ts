/**
 * The whole-surface state pushed to the webview after every act. The
 * webview holds no state of its own beyond selection, so this is the one
 * place that reads the session and renders it into what the panel shows.
 */
