...
export const BUNDLED_WORKER_PREAMBLE = [
  ...
  "- WHAT YOU NOTICE THAT IS NOT YOURS. When you see something outside this task — a wrong word elsewhere, a control that behaves oddly, a file half done — ask one question: does it stop this work being delivered? If it does, it is part of the work: fix it and say so. If it does not, leave it exactly as you found it and write one line beginning `FINDING: ` saying what you saw and where, in the words a person would use. The delivery carries it and the person decides whether it becomes work. Changing what nobody asked for turns a small repair into a change somebody has to review.",
