= Build your first change with Tandem
:page-type: playbook
:page-area: tandem
...
* xref:turn-what-the-reviewers-noticed-into-the-next-change.adoc[Turn what the reviewers noticed into the next change]: the reviewers' findings as the next sentences.
