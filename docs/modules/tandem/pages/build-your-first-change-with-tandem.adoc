...
* xref:index.adoc[Thinkube Tandem]: how a sentence becomes a promise, and how a run works.
...
* xref:words-on-the-page.adoc[The words on the page]: every state word on the run and the report.
...
| Press *Not needed* on the documentation promise with your reason, or let the page be built.
...
| The report says "the reviewers are locked out, so none was started"
| The reviewers' browser could not sign in to the running product
| Open the address yourself and sign in. If that works, press *Run it again*; the lines they would have judged read *not judged* until then.

| *Take it back out* is refused and names a commit
| A commit of your own, made outside Tandem, sits on top of the delivery
| Move that commit aside first; taking the delivery out would take it too.
|===
