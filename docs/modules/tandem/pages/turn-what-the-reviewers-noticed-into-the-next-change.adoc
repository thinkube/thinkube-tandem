...
* xref:index.adoc[Thinkube Tandem]: how a run works and what the report says.
...
* xref:words-on-the-page.adoc[The words on the page]: every state word on the report and the run.
* xref:defects.adoc[The defect ledger, reference]: what the runs caught and repaired.
