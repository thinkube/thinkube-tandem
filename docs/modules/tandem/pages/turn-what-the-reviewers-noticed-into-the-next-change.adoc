...
* xref:build-your-first-change-with-tandem.adoc[Build your first application change with Tandem]: a space with at least one delivered thing.
...
Press *Build the first*, then *Build these N* on the work page, as in xref:build-your-first-change-with-tandem.adoc[Build your first application change with Tandem]. The run builds the thing, deploys it and reports.
...
* xref:build-your-first-change-with-tandem.adoc[Build your first application change with Tandem]: the full path of one thing.
