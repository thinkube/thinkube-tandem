// WHY (INVARIANT): the session gesture that excuses documentation must
// record the human's reason on the session's state, and the cut review
// page rendered afterwards must carry that same reason — the recording and
// the render are the same fact, not two things that can drift apart.
